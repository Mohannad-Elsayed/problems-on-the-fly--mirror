...
u32 in_u32(void) { u32 c, x = 0; while (c = _getchar_nolock(), c < '0' || c > '9') {} while ('/' < c && c < ':') { x = x * 10 + c - '0'; c = _getchar_nolock(); } return x; }
u64 in_u64(void) { u64 c, x = 0; while (c = _getchar_nolock(), c < '0' || c > '9') {} while ('/' < c && c < ':') { x = x * 10 + c - '0'; c = _getchar_nolock(); } return x; }
u128 in_u128(void) { u128 c, x = 0; while (c = _getchar_nolock(), c < '0' || c > '9') {} while ('/' < c && c < ':') { x = x * 10 + c - '0'; c = _getchar_nolock(); } return x; }
i32 in_i32(void) { i32 c, x = 0, f = 1; while (c = _getchar_nolock(), c < '0' || c > '9') { if (c == '-') { f = -f; } } while ('/' < c && c < ':') { x = x * 10 + c - '0'; c = _getchar_nolock(); } return f * x; }
i64 in_i64(void) { i64 c, x = 0, f = 1; while (c = _getchar_nolock(), c < '0' || c > '9') { if (c == '-') { f = -f; } } while ('/' < c && c < ':') { x = x * 10 + c - '0'; c = _getchar_nolock(); } return f * x; }
i128 in_i128(void) { i128 c, x = 0, f = 1; while (c = _getchar_nolock(), c < '0' || c > '9') { if (c == '-') { f = -f; } } while ('/' < c && c < ':') { x = x * 10 + c - '0'; c = _getchar_nolock(); } return f * x; }
void out_u32(u32 x) { if (x >= 10) { out_u32(x / 10); } _putchar_nolock(x - x / 10 * 10 + '0'); }
void out_u64(u64 x) { if (x >= 10) { out_u64(x / 10); } _putchar_nolock(x - x / 10 * 10 + '0'); }
void out_u128(u128 x) { if (x >= 10) { out_u128(x / 10); } _putchar_nolock(x - x / 10 * 10 + '0'); }
void out_i32(i32 x) { if (x < 0) { _putchar_nolock('-'); x = -x; } out_u32((u32)x); }
void out_i64(i64 x) { if (x < 0) { _putchar_nolock('-'); x = -x; } out_u64((u64)x); }
void out_i128(i128 x) { if (x < 0) { _putchar_nolock('-'); x = -x; } out_u128((u128)x); }
void newline(void) { _putchar_nolock('\n'); }
void space(void) { _putchar_nolock(' '); }
void printb_32bit(u32 v) { u32 mask = (u32)1 << (sizeof(v) * CHAR_BIT - 1); do { _putchar_nolock(mask & v ? '1' : '0'); } while (mask >>= 1); }
void printb_64bit(u64 v) { u64 mask = (u64)1 << (sizeof(v) * CHAR_BIT - 1); do { _putchar_nolock(mask & v ? '1' : '0'); } while (mask >>= 1); }
